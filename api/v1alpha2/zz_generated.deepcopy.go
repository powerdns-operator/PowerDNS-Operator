...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterCABundleRef) DeepCopyInto(out *ClusterCABundleRef) {
	*out = *in
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterCABundleRef.
func (in *ClusterCABundleRef) DeepCopy() *ClusterCABundleRef {
	if in == nil {
		return nil
	}
	out := new(ClusterCABundleRef)
	in.DeepCopyInto(out)
	return out
}
